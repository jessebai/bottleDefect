...
%读取原图
gOrg=dicomread('铁-002-003-004-005-006-01-015-02-1');
% figure,imshow(gOrg);
...
%分割一个瓶子
gOrg1=gOrg(nCoordinateX1(2):nCoordinateY1(2),...
    nCoordinateX1(1):nCoordinateY1(1));
% figure,imshow(gOrg1);
...
dTransTheta=affine2d([cos(-sLines1.theta/180*pi) sin(-sLines1.theta/180*pi) 0;
    ...
    0 0 1]);
gBot1=imwarp(gOrg1,dTransTheta,'FillValues',30000);
